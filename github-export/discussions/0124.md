# Discussion #124 — Ability to import datatype declarations from XSD files

- **Author:** @RudyBricks
- **Category:** :bulb: Ideas
- **Created:** 2022-09-19 20:20Z
- **Updated:** 2025-10-29 22:58Z
- **Labels:** Parse / Edit / Serialize, Data Modeling
- **URL:** https://github.com/OAI/sig-moonwalk/discussions/124
...
### Comment 1 — @handrews · 2025-10-29 22:58Z

@RudyBricks in case you are still interested after the last few years:

* issue OAI/OpenAPI-Specification#630 was fixed in OAS v3.2, which dramatically improves XML support for elements, attributes, cdata, and text nodes, which were the only kinds any of us really understood- feedback on what else might still be missing is welcome!
* I wonder if we should revive the "alternative schema" proposal that was kicked around but abandoned when OAS 3.1 went with full JSON Schema support.  I would hesitate to make XSD support part of the "core" spec (by which I mean something that implementations need to support to be considered compliant).  But allowing implementors to experiment with such support (for XSD, or SHACL per #120, or whatever else) might clarify what we might want to eventually officially support.
