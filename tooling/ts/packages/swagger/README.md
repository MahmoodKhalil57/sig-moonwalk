...
<h1 align="center">@suluk/swagger</h1>

<p align="center"><b>Render an OpenAPI v4 'Suluk' document with Swagger UI (via the 3.1 downgrade).</b></p>
...
`@suluk/swagger` is one station on the Suluk walk — author one v4 source, then **validate · audit ·
