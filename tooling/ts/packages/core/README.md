...
<p align="center"><b>Core library for the OpenAPI v4.0 Suluk candidate: parse, validate, resolve, signature, ADA, match.</b></p>
...
`@suluk/core` is one station on the Suluk walk — author one v4 source, then **validate · audit ·
