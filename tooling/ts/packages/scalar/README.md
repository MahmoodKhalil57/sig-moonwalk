...
<p align="center"><b>Render an OpenAPI v4 'Suluk' document with Scalar API Reference (via the 3.1 downgrade).</b></p>
...
`@suluk/scalar` is one station on the Suluk walk — author one v4 source, then **validate · audit ·
