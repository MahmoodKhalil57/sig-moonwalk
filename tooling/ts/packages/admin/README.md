...
<p align="center"><b>The /superadmin web admin panel — the same cockpit as the vscode extension (@suluk/cockpit core), rendered as a Hono-served web UI. Superadmin-gated.</b></p>
...
`@suluk/admin` is one station on the Suluk walk — author one v4 source, then **validate · audit ·
