...
<h1 align="center">@suluk/shadcn</h1>

<p align="center"><b>v4 'Suluk' Schema Objects -> shadcn/ui form + table specs and TSX scaffolds (react-hook-form + zodResolver). Codegen, no runtime UI deps.</b></p>
...
`@suluk/shadcn` is one station on the Suluk walk — author one v4 source, then **validate · audit ·
