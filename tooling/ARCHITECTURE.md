...
| `@suluk/cockpit` | the **pure cockpit core** (10-layer cycle · builder · codegen+**diagrams** · deploy · **drift** · **cross-cut** · **converge** · **D2 diagrams** · **component pixel-confidence** · validate/audit/preview) — shared brain | ✅ 91 tests |
...
**Total: 20 TS packages (383 tests) + a Rust core (9 tests) = 392 green.** Shipped: npm (`@suluk/*`),
