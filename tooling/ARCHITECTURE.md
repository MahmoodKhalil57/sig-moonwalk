...
| `@suluk/cockpit` | the **pure cockpit core** (cycle · builder · codegen · deploy · **drift** · validate/audit/preview) — shared brain | ✅ 54 tests |
...
**Total: 20 TS packages (303 tests) + a Rust core (9 tests) = 312 green.** Shipped: npm (`@suluk/*`),
