...
- Frontier resolved: **51** — all ~56 seeded questions resolved or accounted-for · Deviations: **27+** · ADRs: **C001–C025** (+ `0002`). callbacks/webhooks closed (C018); cost-on-event + jobs-map closed (C024/C025).
